...
if __name__ == '__main__':
    ...
    print('- your following {} users!!!!'.format(len(following)))
    print('- you are followed by {} fans!!!'.format(len(followers)))
    ...
    for _ in list(unreciprocated)[:min(len(unreciprocated), args.num_unfollows)]:
        ...
        print('  - unfollowing losers {}'.format(ig.LastJson['user']['username']))
        ig.unfollow(str(_))
